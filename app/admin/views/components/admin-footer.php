<footer class="border-t border-flyto-sand/10 bg-flyto-navy text-flyto-sand">
    <div class="flex flex-col gap-4 px-6 py-6 sm:flex-row sm:items-center sm:justify-between lg:px-8">
        <div class="flex items-center gap-2">
            <span class="flex h-5 w-5 items-center justify-center bg-flyto-sand/20" aria-hidden="true">
