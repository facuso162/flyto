...
class DenegarPromocionActionController
{
    ...
    public function denegar(array $params = [], array $query = []): void
    {
        if (!$this->ensureAdmin()) {
            return;
        }
        ...
        try {
            ...
            $this->promocionService->denegar($promocionId);
            Flash::success('Solicitud de promoción denegada correctamente.');
        } catch (HttpException $exception) {
            Flash::error($exception->getMessage());
        } catch (Throwable) {
            Flash::error('No pudimos denegar la solicitud. Intentá nuevamente en unos minutos.');
        }
