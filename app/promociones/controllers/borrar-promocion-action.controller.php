...
class BorrarPromocionActionController
{
    ...
    public function borrar(array $params = [], array $query = []): void
    {
        try {
            ...
            Flash::error('Necesitás permisos de CEO para borrar una promocion.');
        ...
        try {
            ...
            $this->promocionService->borrar($promocionId);
            Flash::success('Promoción borrada correctamente.');
        } catch (HttpException $exception) {
            Flash::error($exception->getMessage());
        } catch (Throwable) {
            Flash::error('No pudimos borrar la promoción. Intentá nuevamente en unos minutos.');
        }
