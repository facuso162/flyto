...
<article class="border-b border-flyto-ink/10 px-5 py-5 last:border-b-0 sm:px-6 <?= $esActiva ? 'bg-[rgba(30,45,74,0.03)]' : '' ?>">
    ...
    <div class="mt-3 flex flex-wrap items-center justify-end gap-2">
        ...
        <button type="button" aria-disabled="true" title="Acción disponible próximamente" class="flex items-center gap-1.5 border border-flyto-ink/10 px-3 py-1.5 text-xs font-medium text-flyto-ink">
