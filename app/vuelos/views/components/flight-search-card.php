...
<form id="buscar-vuelos" action="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/vuelos/buscar" method="get" class="bg-white p-6 shadow-flyto">
    <div class="grid border border-flyto-ink/10 md:grid-cols-[1fr_56px_1fr_160px_140px]">
        <label for="origen" class="block border-b border-flyto-ink/10 p-4 md:border-b-0 md:border-r">
            ...
            <select id="origen" tabindex="1" name="origen" class="mt-1 block w-full bg-transparent font-display text-2xl font-semibold leading-6 text-flyto-ink outline-none" aria-describedby="origen_nombre" data-city-select data-description-target="origen_nombre" required>
        ...
        <button id="change-destiny-origin" tabindex="2" type="button" class="flex h-12 items-center justify-center border-b border-flyto-ink/10 text-flyto-muted hover:text-flyto-navy md:h-auto md:border-b-0 md:border-r" aria-label="Intercambiar origen y destino">
            <svg class="h-4 w-4 text-flyto-muted" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <label for="destino" class="block border-b border-flyto-ink/10 p-4 md:border-b-0 md:border-r">
            ...
            <select id="destino" tabindex="3" name="destino" class="mt-1 block w-full bg-transparent font-display text-2xl font-semibold leading-6 text-flyto-ink outline-none" aria-describedby="destino_nombre" data-city-select data-description-target="destino_nombre" required>
        ...
        <label for="cantidadPasajeros" class="block p-4">
            ...
            <select id="cantidadPasajeros" tabindex="5" name="cantidadPasajeros" class="mt-1 block w-full bg-transparent text-sm font-medium leading-5 text-flyto-ink outline-none" required>
