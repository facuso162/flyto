...
class ReporteVentasPageController
{
    ...
    public function show(array $params, array $query, string $layoutPath): void
    {
        ...
        $this->viewResponse->render(
            __DIR__ . '/../views/pages/reporte-ventas.page.php',
            'Reporte de ventas - Panel CEO - Flyto',
            [
                'reporte' => $this->reporteService->generarReporteVentas($ceoId),
            ],
            200,
            $layoutPath
        );
