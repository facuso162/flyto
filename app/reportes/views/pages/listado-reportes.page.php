        ...
        <div class="mt-8 border border-flyto-ink/10 bg-white">
            ...
            <?php foreach ($reportes as $reporte): ?>
                <?php
                    ...
                    $urlReporte = $basePath . '/ceo/reportes/' . rawurlencode($slug);
                ?>
                <article class="grid gap-4 border-b border-flyto-ink/10 px-5 py-6 last:border-b-0 sm:grid-cols-[auto_minmax(0,1fr)_auto] sm:items-center">
