...
$value = static fn (string $field): string => $html($oldInput[$field] ?? '');
...
<section class="px-5 py-8 sm:px-8">
    <div class="mx-auto max-w-[768px]">
        <p class="font-mono text-xs uppercase tracking-[0.1em] text-flyto-muted">Nueva novedad</p>
        <h1 class="mt-1 font-display text-3xl font-medium tracking-tight text-flyto-ink">Agregar novedad</h1>
        ...
        <form method="post" action="<?= $html($basePath) ?>/admin/novedades/crear" class="mt-6" novalidate>
